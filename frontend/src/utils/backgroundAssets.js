...
export const BACKGROUND_VARIANTS = {
  ...
  studio: {
    background: '#07142B',
    image: BACKGROUND_ASSETS.heroStudio,
    overlay: 'rgba(6, 19, 36, 0.78)',
    position: 'center',
  },
  services: {
    background: '#07142B',
    image: BACKGROUND_ASSETS.webDevelopment,
    overlay: 'rgba(6, 19, 36, 0.72)',
    position: 'center',
  },
  product: {
    background: '#07142B',
    image: BACKGROUND_ASSETS.landingWallpaper,
    overlay: 'rgba(6, 19, 36, 0.72)',
    position: 'center',
  },
  portfolio: {
  ...
  booking: {
    background: '#07142B',
    image: BACKGROUND_ASSETS.softwareCompany,
    overlay: 'rgba(6, 19, 36, 0.76)',
    position: 'center',
  },
  legal: {
    background: '#F5F7FA',
