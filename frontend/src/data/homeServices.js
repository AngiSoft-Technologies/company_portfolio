...
const homeServices = [
  {
    ...
    icon: 'FaLaptopCode',
    image: resolveAssetUrl('/uploads/public/images/services/software-development.jpg'),
  ...
  },
  {
    ...
    name: 'Data Analysis',
    icon: 'FaChartLine',
    image: resolveAssetUrl('/uploads/public/images/services/data-analysis.jpg'),
  ...
  },
  {
    ...
    icon: 'FaShieldAlt',
    image: resolveAssetUrl('/uploads/public/images/services/documents-cyber.jpg'),
  ...
  },
  {
    ...
    icon: 'FaMobileAlt',
    image: resolveAssetUrl('/uploads/public/images/services/creative-products.jpg'),
