...
const Experience = ({ theme }) => {
    ...
    return (
        <section id="experience" className={`p-6 justify-center items-center transition-opacity duration-700 ${visible ? 'opacity-100' : 'opacity-0'}`}> 
            <h2 className="text-4xl font-extrabold mb-6 tracking-tight text-gradient bg-gradient-to-r from-[#0A3DFF] to-[#00C2FF] bg-clip-text text-transparent animate-fade-in">Experience</h2>
