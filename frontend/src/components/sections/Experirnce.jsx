...
const Experience = ({ theme }) => {
    ...
    return (
        <section id="experience" className={`p-6 justify-center items-center transition-opacity duration-700 ${visible ? 'opacity-100' : 'opacity-0'}`}> 
            <h2 className="text-4xl font-extrabold mb-6 tracking-tight text-gradient bg-gradient-to-r from-[#0875FF] to-[#00AFFF] bg-clip-text text-transparent animate-fade-in">Experience</h2>
